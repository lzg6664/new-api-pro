...
func InitEnv() {
	...
	RelayTraceEnabled = GetEnvOrDefaultBool("RELAY_TRACE", true)
...
func initConstantEnv() {
	...
	constant.MaxRequestBodyMB = GetEnvOrDefault("MAX_REQUEST_BODY_MB", 1024)
	...
	// 终态任务保留天数：超过后由清理循环物理删除。0 表示禁用清理。
	constant.TaskRetentionDays = GetEnvOrDefault("TASK_RETENTION_DAYS", 7)
